...
class Record:
    def __init__(self, name: Name, phone: Phone = None, birthday: Birthday = None):
        ...
        self.birthday = birthday.value if birthday.value is not None else "birthday is not defined"
    ...
    def days_to_birthday(self):
        ...
        if self.birthday == "birthday is not defined":
...
book = AddressBook()
new_record_1 = Record("Bill", Phone("0000000000"), Birthday("01.12.2001"))
